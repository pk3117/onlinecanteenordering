  ...
  <div>
    <nav class="navbar navbar-expand-md fixed-top">
      <div class="container-fluid nav-container">
        <a class="navbar-brand me-auto logo" href="index.php">SRM GOOD FOODS</a>
            ...
            <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <li><a class="dropdown-item" href="menu.php#appetizer">INDIAN</a></li>
                  <li><a class="dropdown-item" href="menu.php#pizza">CHINESE</a></li>
                  <li><a class="dropdown-item" href="menu.php#burger">ITALIAN</a></li>
