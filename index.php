      ...
      <div class="container mt-3">
        <div class="row d-flex justify-content-start align-items-start main-container">
          <div class="col-md-5 col-sm-12 col-lg-5 reveal main-text mb-4 text-align-justify mt-5" data-aos="fade-up">
            <h2>Welcome to <span style="color: #fb4a36;"> SRM GOOD FOOD,</span></h2>
            ...
            <p style="font-size: 18px; text-align: justify;">
              ...
              flavor. At SRM GOOD FOODS, we believe in making every meal an
          ...
          <div class="col-md-7 col-sm-12 col-lg-7 d-flex justify-content-center align-items-start slide-in-right main-image">
            <img src="images/Pizza.jpeg" class="img" style=" width: 50%; height: 90%;">
          </div>
        </div>
        <div class="row">
          <!-- Menu Section -->
      ...
      <div class="container ">
        ...
        <div class="story-content row mb-2">
          <div class="story-text col-lg-6 col-md-6 col-sm-12 reveal mt-2" data-aos="fade-up" data-os-interval="300">
            <p>At <strong>SRM GOOD FOODS</strong>, we are passionate about celebrating food. Our chefs bring a touch of creativity to every dish, ensuring a feast for your senses. Join us for an extraordinary dining experience that celebrates flavor and joy.</p>
            <p>Founded in [2020], SRM GOOD FOODS has been at the forefront of culinary innovation. Our commitment to using the freshest ingredients, combined with our chefs' expertise, has earned us a reputation for excellence. We believe that dining is not just about eating; it's about experiencing the art of food.</p>
            <p>Whether you're looking for a romantic dinner, a family gathering, or a place to celebrate special occasions, SRM GOOD FOODS offers the perfect ambiance and exquisite cuisine to make your visit unforgettable. Come and experience the joy of flavor with us!</p>
    ...
    <div class="footer-container">
      <div class="footer-row">
        <div class="footer-col" id="contact">
          <h4>Contact Us</h4>
          <p>123 Bharathi Salai, Ramapuram ,Chennai</p>
          <p>Email: info@srmgoodfoods.com</p>
          <p>Phone: +91 87 123 4567</p>
        </div>
      ...
      <div class="footer-bottom">
        <h4>&copy; 2000 Authored by IISAI. All Rights Reserved.</h4>
      </div>
    </div>
  </footer>
